  ...
  return (
    ...
    <div class="searchbar-wrapper">
        ...
        <div class="searchbar-center">
            ...
            <input onChange={onChange} type="text" class="searchbar-input" maxlength="2048" name="q" autocapitalize="off" autocomplete="off" title="Search" role="combobox" placeholder={placeholder}/>
        </div>
