  ...
  const steps = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brass" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="how-it-works" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 font-sans">
      <div className="text-center mb-14">
        <h2 className="text-3xl font-serif font-bold text-ivory">
          Why Choose <span className="text-brass">Air-Bnb</span>?
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
        {steps.map((item, idx) => (
          ...
          >
            ...
            <h3 className="text-base font-bold text-ivory/80 mb-3 group-hover:text-brass transition-colors">
              {item.title}
            </h3>
