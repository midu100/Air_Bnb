      ...
      <div className="max-w-md w-full bg-white p-8 md:p-10 rounded-3xl border border-gray-100 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[11px] text-gray-500 mt-1">
            Join us to explore and book the world's finest stays
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 animate-fade-in">
          ...
          <div className="flex items-center mt-2">
            <input
              ...
              type="checkbox"
              required
              className="h-4 w-4 bg-white border-gray-200 text-brand focus:ring-brand/20 rounded accent-brand cursor-pointer"
            />
            <label htmlFor="terms" className="ml-2 block text-[10px] text-gray-500 cursor-pointer select-none">
              I agree to the{' '}
          ...
          <button
            type="submit"
            className="w-full btn-brand py-3 text-xs rounded-xl mt-4"
          >
            Create Account
          </button>
        </form>
